...
The harness now also emits a `pca_cauchy_bound_cascade` family for safe
low-rank-plus-tail pruning. It scores the local PCA representation, stores an
extra fp16 residual norm per row, and uses a conservative Cauchy tail bound:
prune a row only when `approx + bound` cannot beat the target lower-bound
...
## Graph-Visited PQ/Local-Residual-PQ q0..24 Stress Pass

The q0..9 graph-visited artifact above is the full method ladder, including
OPQ-style and local residual-OPQ lanes. The broader q0..24 stress pass covers
the currently most decision-relevant lanes: global PQ and local
residual-PQ, plus the existing scalar and local-PCA baselines emitted by the
harness. A q0..99 full-ladder run and a q0..99 focused run were too large for
the interactive timeout before producing a report, so this q0..24 pass is
broader than q0..9 but still not final production coverage.

Run artifact:

```text
/tmp/gomap_deep1b_buildable_graph_visited_pq_lrpq_q0_24_20260520_062116/report.md
```
...
| Granule rows | `4096` |
| Granules | `8` |
| Granule build ms | `778.625` |
| Routing graph build ms | `758.292` |
| K-means iterations | `6` |
| Graph degree | `16` |
| Graph entry clusters | `4` |
| Queries | `0..24` |
...
Training cost and metadata for the focused trained-codebook lanes:

| Method family | Budgets | Train ms | Metadata B/eval-vector | Interpretation |
| --- | --- | ---: | ---: | --- |
| global PQ | `32/48/64/80/96` | `780.4-1377.7` | `1.50` | simple fixed-byte trained baseline |
| local residual-PQ | `32/48/64` | `3070.7-4557.9` | `12.05` | local residual challenger with real metadata cost |

The broader query slice makes the routing failure mode much clearer than q0..9.
Top4 graph-visited blocks usually route the exact winners, but hard queries now
miss winners before compression. That means the codec tables below are
conditional on the selected block union; they are not full search recall.

| Selection | Queries | Candidate rows | p50 top10 routed | p90 top10 routed | Worst top10 routed | p50 top20 routed | p90 top20 routed | Worst top20 routed | p50 top50 routed | Worst top50 routed |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| top1 graph-visited block | `25` | `4096` | `5/10` | `10/10` | `0/10` | `8/20` | `20/20` | `0/20` | `22/50` | `0/50` |
| top4 graph-visited blocks | `25` | `16384` | `10/10` | `10/10` | `6/10` | `20/20` | `20/20` | `10/20` | `48/50` | `29/50` |

Selected aggregate codec rows:

| Selection | Method | Row-code B/vector | Metadata B/vector | Avg total KiB/query | Worst top10@20 | Worst top10@50 | Worst top20@50 | Worst rerank@20 recall@10 | Avg score err | Scan ns/vector |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| top1 | `global_pq_32B` | `32` | `3.50` | `142.0` | `6/10` | `10/10` | `17/20` | `0.60` | `0.01762` | `27.77` |
| top1 | `local_residual_pq_32B` | `32` | `14.05` | `184.2` | `8/10` | `10/10` | `19/20` | `0.80` | `0.01418` | `27.17` |
| top1 | `global_pq_48B` | `48` | `3.50` | `206.0` | `8/10` | `10/10` | `20/20` | `0.80` | `0.00829` | `51.17` |
| top1 | `local_residual_pq_48B` | `48` | `14.05` | `248.2` | `10/10` | `10/10` | `20/20` | `1.00` | `0.00681` | `42.63` |
| top1 | `global_pq_64B` | `64` | `3.50` | `270.0` | `9/10` | `10/10` | `20/20` | `0.90` | `0.00694` | `54.55` |
| top1 | `local_residual_pq_64B` | `64` | `14.05` | `312.2` | `10/10` | `10/10` | `20/20` | `1.00` | `0.00570` | `59.36` |
| top1 | `global_pq_80B` | `80` | `3.50` | `334.0` | `10/10` | `10/10` | `20/20` | `1.00` | `0.00500` | `71.53` |
| top1 | `global_pq_96B` | `96` | `3.50` | `398.0` | `10/10` | `10/10` | `20/20` | `1.00` | `0.00153` | `98.16` |
| top1 | `scalar_u8` | `96` | `0.19` | `384.8` | `10/10` | `10/10` | `20/20` | `1.00` | `0.00057` | `1665.34` |
| top4 | `global_pq_32B` | `32` | `3.50` | `568.0` | `7/10` | `10/10` | `17/20` | `0.70` | `0.01707` | `27.35` |
| top4 | `local_residual_pq_32B` | `32` | `14.05` | `736.8` | `8/10` | `9/10` | `18/20` | `0.80` | `0.01408` | `28.07` |
| top4 | `local_pca_rank32` | `32` | `3.56` | `569.0` | `0/10` | `3/10` | `5/20` | `0.00` | `0.02911` | `51.74` |
| top4 | `global_pq_48B` | `48` | `3.50` | `824.0` | `8/10` | `10/10` | `20/20` | `0.80` | `0.00808` | `42.61` |
| top4 | `local_residual_pq_48B` | `48` | `14.05` | `992.8` | `10/10` | `10/10` | `20/20` | `1.00` | `0.00679` | `45.90` |
| top4 | `scalar_u4` | `48` | `0.19` | `771.0` | `9/10` | `10/10` | `19/20` | `0.90` | `0.00978` | `1637.58` |
| top4 | `global_pq_64B` | `64` | `3.50` | `1080.0` | `9/10` | `10/10` | `20/20` | `0.90` | `0.00674` | `60.36` |
| top4 | `local_residual_pq_64B` | `64` | `14.05` | `1248.8` | `10/10` | `10/10` | `19/20` | `1.00` | `0.00569` | `64.53` |
| top4 | `local_pca_rank64` | `64` | `5.08` | `1105.2` | `7/10` | `10/10` | `19/20` | `0.70` | `0.01230` | `130.32` |
| top4 | `global_pq_80B` | `80` | `3.50` | `1336.0` | `10/10` | `10/10` | `20/20` | `1.00` | `0.00490` | `74.10` |
| top4 | `local_pca_rank80` | `80` | `5.84` | `1373.4` | `9/10` | `10/10` | `19/20` | `0.90` | `0.00690` | `162.98` |
| top4 | `global_pq_96B` | `96` | `3.50` | `1592.0` | `10/10` | `10/10` | `20/20` | `1.00` | `0.00145` | `99.60` |
| top4 | `local_pca_rank96` | `96` | `6.59` | `1641.5` | `10/10` | `10/10` | `20/20` | `1.00` | `0.00081` | `196.55` |
| top4 | `scalar_u8` | `96` | `0.19` | `1539.0` | `10/10` | `10/10` | `20/20` | `1.00` | `0.00058` | `1588.22` |

Selected cascade rows:

| Selection | Method | Selected-code KiB/query | p50 scan us | p90 scan us | p50 measured cascade@50 us | p90 measured cascade@50 us | p50 int8 cascade@50 us | p90 int8 cascade@50 us |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| top4 | `global_pq_48B` | `824.0` | `706.21` | `972.88` | `818.13` | `1111.88` | `984.84` | `1275.11` |
| top4 | `local_residual_pq_48B` | `992.8` | `667.00` | `1248.08` | `778.29` | `1498.71` | `986.80` | `1592.85` |
| top4 | `global_pq_80B` | `1336.0` | n/a | n/a | `1247.50` | `2026.42` | n/a | n/a |
| top4 | `global_pq_96B` | `1592.0` | n/a | n/a | `1615.29` | `3001.75` | n/a | n/a |
| top4 | `scalar_u8` | `1539.0` | n/a | n/a | `23660.42` | `39442.00` | n/a | n/a |

Interpretation:

- The q0..24 pass confirms that routing is the first production gate. Top4
  graph-visited routing has p50-perfect top10/top20 containment, but worst
  queries route only `6/10` top10 and `10/20` top20 winners. No codec or rerank
  stage can recover winners that never enter the selected block union.
- Conditional on routed blocks, global PQ48 remains a clean low-metadata
  candidate generator: `48 B` row code, `3.50 B/vector` selected metadata,
  worst `10/10` top10@50 and `20/20` top20@50, but only `8/10` worst top10@20.
- Local residual-PQ48 repairs the conditional worst top10@20 and rerank@20 gates
  in this run, but it spends about `10.55 B/vector` more selected metadata than
  global PQ. That makes it a real challenger, not a free upgrade.
- Global PQ80/PQ96 saturate the measured conditional gates with low metadata.
  The additional bytes mostly buy lower score error and safer compressed
  ranking, not a fix for routing misses.
- Local PCA remains weak on hard graph-visited unions. Rank32 collapses, rank64
  still misses top10@20 badly, and rank96 is accurate but slower than PQ and no
  smaller than full SQ8.
- Scalar u4/u8 quality is useful as a conservative reference, but the current
  reconstructed Go scorer is one to two orders of magnitude slower than the PQ
...
## Graph-Routed TreeDB Part-Granule Scout q0..24

This pass wires `graph_visited_blocks` selection into
`treedb_graph_sorted_part_granules`. Rows are still stored through
`BuildColumnPart` and candidate units are still actual
`ColumnPart.Descriptor.Granules`; the difference is routing. Instead of ranking
descriptor granules by centroid score, the query starts from static IVF centroid
entry rows, greedily expands the query-independent IVF-window row graph using
exact query-to-row scores, then reads the sealed descriptor granules that
contain visited rows.

This is closer to a graph visited-set route than centroid-ranked descriptor
granules. It is still not a full production HNSW/TreeDB graph implementation.

Run artifact:

```text
/tmp/gomap_deep1b_treedb_part_graph_visited_q0_24_20260520_071944/report.md
```
...
| Actual `ColumnPart` descriptor granules | `8` |
| Rows per descriptor granule | `4096` |
| Granule build ms | `843.738` |
| Routing graph build ms | `882.079` |
| K-means iterations | `8` |
| Graph degree | `16` |
| Graph entry clusters | `4` |
| Queries | `0..24` |
...
Routing is worse on hard descriptor-granule cases than the centroid-routed pass
above. Top4 graph-routed descriptor granules remain p50-perfect for top10/top20
containment, but the worst query routes only `1/10` top10 and `4/20` top20
winners. In the centroid-routed descriptor pass, the corresponding worst top4
counts were `4/10` and `9/20`. This is an important negative result: this
IVF-window graph-walk route over descriptor granules does not repair hard
routing misses in the current q0..24/32K setup.

| Selection | Queries | Avg candidate rows | p50 top10 routed | p90 top10 routed | Worst top10 routed | p50 top20 routed | p90 top20 routed | Worst top20 routed | p50 top50 routed | Worst top50 routed |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| top1 graph-routed descriptor granule | `25` | `4096.0` | `5/10` | `10/10` | `0/10` | `9/20` | `20/20` | `0/20` | `21/50` | `0/50` |
| top4 graph-routed descriptor granules | `25` | `16384.0` | `10/10` | `10/10` | `1/10` | `20/20` | `20/20` | `4/20` | `48/50` | `10/50` |

Selected aggregate codec rows:

| Selection | Method | Row-code B/vector | Metadata B/vector | Avg total KiB/query | Worst top10@20 | Worst top10@50 | Worst top20@50 | Worst rerank@20 recall@10 | Avg score err | Scan ns/vector |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| top1 | `global_pq_32B` | `32` | `3.50` | `142.0` | `6/10` | `10/10` | `17/20` | `0.60` | `0.01754` | `17.32` |
| top1 | `local_pca_rank32` | `32` | `3.56` | `142.2` | `2/10` | `2/10` | `11/20` | `0.20` | `0.02604` | `30.85` |
| top1 | `local_residual_pq_32B` | `32` | `14.05` | `184.2` | `9/10` | `10/10` | `19/20` | `0.90` | `0.01413` | `18.31` |
| top4 | `global_pq_32B` | `32` | `3.50` | `568.0` | `7/10` | `10/10` | `17/20` | `0.70` | `0.01705` | `17.75` |
| top4 | `local_residual_pq_32B` | `32` | `14.05` | `736.8` | `9/10` | `10/10` | `18/20` | `0.90` | `0.01406` | `17.34` |
| top1 | `global_pq_48B` | `48` | `3.50` | `206.0` | `8/10` | `10/10` | `19/20` | `0.80` | `0.00825` | `27.81` |
| top1 | `local_residual_pq_48B` | `48` | `14.05` | `248.2` | `10/10` | `10/10` | `19/20` | `1.00` | `0.00682` | `25.83` |
| top1 | `scalar_u4` | `48` | `0.19` | `192.8` | `9/10` | `10/10` | `20/20` | `0.90` | `0.00973` | `1026.23` |
| top4 | `global_pq_48B` | `48` | `3.50` | `824.0` | `8/10` | `10/10` | `20/20` | `0.80` | `0.00807` | `26.86` |
| top4 | `local_residual_pq_48B` | `48` | `14.05` | `992.8` | `9/10` | `10/10` | `20/20` | `0.90` | `0.00681` | `27.76` |
| top1 | `global_pq_64B` | `64` | `3.50` | `270.0` | `9/10` | `10/10` | `19/20` | `0.90` | `0.00692` | `35.95` |
| top1 | `local_residual_pq_64B` | `64` | `14.05` | `312.2` | `10/10` | `10/10` | `19/20` | `1.00` | `0.00571` | `35.06` |
| top4 | `global_pq_64B` | `64` | `3.50` | `1080.0` | `9/10` | `10/10` | `20/20` | `0.90` | `0.00673` | `35.28` |
| top4 | `local_residual_pq_64B` | `64` | `14.05` | `1248.8` | `10/10` | `10/10` | `20/20` | `1.00` | `0.00571` | `37.15` |
| top1 | `global_pq_80B` | `80` | `3.50` | `334.0` | `10/10` | `10/10` | `19/20` | `1.00` | `0.00498` | `44.20` |
| top4 | `global_pq_80B` | `80` | `3.50` | `1336.0` | `10/10` | `10/10` | `20/20` | `1.00` | `0.00489` | `45.83` |
| top1 | `global_pq_96B` | `96` | `3.50` | `398.0` | `10/10` | `10/10` | `20/20` | `1.00` | `0.00152` | `67.39` |
| top4 | `scalar_u8` | `96` | `0.19` | `1539.0` | `10/10` | `10/10` | `20/20` | `1.00` | `0.00058` | `1045.03` |

Interpretation:

- This is the first q0..24 run where graph-walk selection expands to actual
  `ColumnPart.Descriptor.Granules`.
- The graph route is a negative routing result in this setup. It is worse than
  centroid descriptor routing on hard queries, so the next production locality
  question is not “which codec repairs this,” but “which buildable graph route
  gets the exact winners into the candidate union.”
- Conditional on the routed descriptor granules, the codec frontier is stable.
  Global PQ48 remains the clean low-metadata candidate-generator. Global PQ80 is
  the first strict top10@20 gate-clearer. Local residual-PQ32/48/64 improves
  hard conditional gates at significant metadata cost.
- The production bottleneck remains route/locality construction. Codecs cannot
  recover exact winners that were not routed into the selected descriptor
  granules.

## Exact Graph-Neighborhood Block Scout q0..24

This pass runs the stronger `ivf_exact_graph_neighborhood_blocks` builder at
the same q0..24 / 32K shape as the descriptor-granule scouts. Rows are assigned
to deterministic cosine IVF centroids, an exact in-cluster kNN graph is built
over the eval slice, and fixed-size graph-BFS neighborhoods become storage
blocks. This is a production/buildable graph-neighborhood proxy and a stronger
locality test than the IVF-window graph. It is still not a full production
HNSW/TreeDB graph build, and the exact adjacency build cost should be treated
as scout evidence rather than a proposed production build path.

Run artifact:

```text
/tmp/gomap_deep1b_exact_graph_neighborhood_q0_24_20260520_073413/report.md
```
...
| Dims | `96` |
| Granules | `8` |
| Rows per granule | `4096` |
| Granule build ms | `25817.609` |
| K-means iterations | `8` |
| Graph degree | `16` |
| Queries | `0..24` |
| Top granules | `1,4` |
...
Routing improves materially compared with the descriptor-granule graph route:
top4 worst top10 routed rises from `1/10` to `8/10`, and worst top20 routed
rises from `4/20` to `13/20`. It also improves the centroid-routed descriptor
worst cases (`4/10` top10 and `9/20` top20). The result is still not complete
routing: even this stronger exact-neighborhood proxy misses `2/10` top10 and
`7/20` top20 winners on the worst q0..24 top4 query before compression.

| Selection | Queries | Avg candidate rows | p50 top10 routed | p90 top10 routed | Worst top10 routed | p50 top20 routed | p90 top20 routed | Worst top20 routed | p50 top50 routed | Worst top50 routed |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| top1 exact graph-neighborhood block | `25` | `4096.0` | `7/10` | `10/10` | `0/10` | `13/20` | `20/20` | `3/20` | `30/50` | `6/50` |
| top4 exact graph-neighborhood blocks | `25` | `16384.0` | `10/10` | `10/10` | `8/10` | `20/20` | `20/20` | `13/20` | `48/50` | `35/50` |

Selected aggregate codec rows:

| Selection | Method | Row-code B/vector | Metadata B/vector | Avg total KiB/query | Worst top10@20 | Worst top10@50 | Worst top20@50 | Worst rerank@20 recall@10 | Avg score err | Scan ns/vector |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| top1 | `global_pq_32B` | `32` | `3.50` | `142.0` | `7/10` | `10/10` | `17/20` | `0.70` | `0.01797` | `16.16` |
| top1 | `local_pca_rank32` | `32` | `3.56` | `142.2` | `2/10` | `4/10` | `10/20` | `0.20` | `0.02410` | `28.82` |
| top1 | `local_residual_pq_32B` | `32` | `14.05` | `184.2` | `9/10` | `10/10` | `17/20` | `0.90` | `0.01424` | `16.45` |
| top4 | `global_pq_32B` | `32` | `3.50` | `568.0` | `7/10` | `10/10` | `17/20` | `0.70` | `0.01714` | `15.88` |
| top4 | `local_residual_pq_32B` | `32` | `14.05` | `736.8` | `8/10` | `10/10` | `17/20` | `0.80` | `0.01415` | `17.03` |
| top1 | `global_pq_48B` | `48` | `3.50` | `206.0` | `8/10` | `10/10` | `19/20` | `0.80` | `0.00844` | `25.67` |
| top1 | `local_residual_pq_48B` | `48` | `14.05` | `248.2` | `9/10` | `10/10` | `20/20` | `0.90` | `0.00687` | `26.61` |
| top1 | `scalar_u4` | `48` | `0.19` | `192.8` | `9/10` | `10/10` | `20/20` | `0.90` | `0.00977` | `985.85` |
| top4 | `global_pq_48B` | `48` | `3.50` | `824.0` | `8/10` | `10/10` | `20/20` | `0.80` | `0.00810` | `28.12` |
| top4 | `local_residual_pq_48B` | `48` | `14.05` | `992.8` | `9/10` | `10/10` | `20/20` | `0.90` | `0.00684` | `25.82` |
| top4 | `scalar_u4` | `48` | `0.19` | `771.0` | `10/10` | `10/10` | `20/20` | `1.00` | `0.00981` | `1000.33` |
| top1 | `global_pq_64B` | `64` | `3.50` | `270.0` | `9/10` | `10/10` | `19/20` | `0.90` | `0.00707` | `35.80` |
| top1 | `local_residual_pq_64B` | `64` | `14.05` | `312.2` | `9/10` | `10/10` | `20/20` | `0.90` | `0.00574` | `34.09` |
| top4 | `global_pq_64B` | `64` | `3.50` | `1080.0` | `9/10` | `10/10` | `20/20` | `0.90` | `0.00676` | `35.20` |
| top4 | `local_residual_pq_64B` | `64` | `14.05` | `1248.8` | `9/10` | `10/10` | `20/20` | `0.90` | `0.00572` | `36.99` |
| top1 | `global_pq_80B` | `80` | `3.50` | `334.0` | `10/10` | `10/10` | `19/20` | `1.00` | `0.00512` | `43.54` |
| top4 | `global_pq_80B` | `80` | `3.50` | `1336.0` | `10/10` | `10/10` | `20/20` | `1.00` | `0.00491` | `43.89` |
| top1 | `global_pq_96B` | `96` | `3.50` | `398.0` | `10/10` | `10/10` | `20/20` | `1.00` | `0.00158` | `56.57` |
| top1 | `scalar_u8` | `96` | `0.19` | `384.8` | `10/10` | `10/10` | `20/20` | `1.00` | `0.00057` | `983.16` |
| top4 | `global_pq_96B` | `96` | `3.50` | `1592.0` | `10/10` | `10/10` | `20/20` | `1.00` | `0.00147` | `57.34` |
| top4 | `scalar_u8` | `96` | `0.19` | `1539.0` | `10/10` | `10/10` | `20/20` | `1.00` | `0.00058` | `991.06` |

Selected cascade rows:

| Selection | Method | Selected-code KiB/query | p50 candidate rows | p50 scan us | p95 scan us | p50 fp32 cascade@50 us | p95 fp32 cascade@50 us | Avg fp32 cascade@50 KiB |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| top1 | `global_pq_32B` | `142.0` | `4096` | `64.79` | `73.71` | `87.23` | `95.10` | `160.9` |
| top4 | `global_pq_32B` | `568.0` | `16384` | `258.08` | `270.71` | `301.96` | `317.79` | `586.9` |
| top1 | `global_pq_48B` | `206.0` | `4096` | `101.96` | `112.71` | `123.81` | `140.98` | `224.9` |
| top4 | `global_pq_48B` | `824.0` | `16384` | `410.25` | `454.21` | `453.52` | `495.23` | `842.9` |
| top1 | `global_pq_80B` | `334.0` | `4096` | `175.00` | `186.88` | `198.71` | `211.35` | `352.9` |
| top4 | `global_pq_80B` | `1336.0` | `16384` | `703.54` | `776.75` | `744.77` | `822.08` | `1354.9` |
| top1 | `scalar_u4` | `192.8` | `4096` | `3961.62` | `4476.62` | `3983.17` | `4498.81` | `211.7` |
| top4 | `scalar_u4` | `771.0` | `16384` | `15853.58` | `18782.08` | `15890.56` | `18820.58` | `789.9` |

Interpretation:

- Exact graph-neighborhood blocks materially improve hard-query routing versus
  both centroid-routed and graph-routed TreeDB descriptor granules in this
  q0..24/32K scout.
- The win is not enough for production promotion. Top4 still misses routed
  winners on the worst query, and the exact graph builder spends `25.8 s` to
  build only `32768` eval rows.
- Conditional codec results do not change the frontier. Local PCA is still
  weak at matched bytes. Local residual-PQ lowers score error and repairs some
  conditional gates, but it does not buy a decisive gate win over global PQ at
  its extra metadata cost.
- PQ80/PQ96 and scalar/SQ8 clear the wider candidate gates, but strict exact
  rerank still depends on the route placing true winners in the candidate
  block union. The next production question is how to build similar locality
  cheaply and/or use larger candidate unions without over-reading.

## Dynamic Graph-Visited Row Scout q0..24

The graph-visited block pass above expands a graph route to sealed storage
blocks. That is the right storage-layout question, but it can hide whether the
route itself found the right rows before block expansion. This follow-up uses
the same `ivf_graph_sorted_blocks` graph proxy, but changes selection to
`graph_visited_rows`: the query starts from static IVF centroid entry rows,
greedily expands the query-independent row graph using exact query-to-row
scores, and evaluates the visited rows directly.

This is a dynamic query-time visited-row scout. It is not a sealed TreeDB
granule proof, and it is not a valid place to fit local PCA or local
per-granule codebooks. Those lanes are intentionally skipped here. The value of
this pass is to separate route quality from storage-block fetch policy.

Run artifact:

```text
/tmp/gomap_deep1b_graph_visited_rows_pq_q0_24_20260520_064518/report.md
```
...
| Regime | `buildable_granule_scout` |
| Builder | `ivf_graph_sorted_blocks` |
| Selection | `graph_visited_rows` |
| Eval rows | `32768` |
| Eval row offset | `8192` |
| Dims | `96` |
| Granule rows / target rows per visit unit | `4096` |
| Graph-sorted storage granules | `8` |
| Granule build ms | `897.079` |
| Routing graph build ms | `808.317` |
| K-means iterations | `8` |
| Graph degree | `16` |
| Graph entry clusters | `4` |
| Queries | `0..24` |
...
Compared with graph-visited block expansion, dynamic visited rows are much
stronger at the same top1 row budget. Top1 reads `4096` rows in both modes, but
dynamic rows improve p50 top10 routing from `5/10` to `10/10` and worst top10
routing from `0/10` to `6/10`. Top4 remains limited by hard graph-routing
cases: query `6` still routes only `6/10` top10 and `12/20` top20 even when
expanding to about `13k` visited rows. That is a routing/entry-graph failure,
not a codec failure.

| Selection | Queries | Avg candidate rows | p50 top10 routed | p90 top10 routed | Worst top10 routed | p50 top20 routed | p90 top20 routed | Worst top20 routed | p50 top50 routed | Worst top50 routed |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| top1 dynamic visited rows | `25` | `4096.0` | `10/10` | `10/10` | `6/10` | `20/20` | `20/20` | `10/20` | `47/50` | `27/50` |
| top4 dynamic visited rows | `25` | `15415.0` | `10/10` | `10/10` | `6/10` | `20/20` | `20/20` | `12/20` | `49/50` | `39/50` |

Selected aggregate codec rows:

| Selection | Method | Row-code B/vector | Metadata B/vector | Avg total KiB/query | Worst top10@20 | Worst top10@50 | Worst top20@50 | Worst rerank@20 recall@10 | Avg score err | Scan ns/vector |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| top1 | `global_pq_32B` | `32` | `3.50` | `142.0` | `7/10` | `10/10` | `17/20` | `0.70` | `0.01858` | `21.05` |
| top4 | `global_pq_32B` | `32` | `3.50` | `534.4` | `7/10` | `10/10` | `17/20` | `0.70` | `0.01714` | `25.42` |
| top1 | `global_pq_48B` | `48` | `3.50` | `206.0` | `8/10` | `10/10` | `20/20` | `0.80` | `0.00852` | `237.08` |
| top4 | `global_pq_48B` | `48` | `3.50` | `775.3` | `8/10` | `10/10` | `20/20` | `0.80` | `0.00812` | `41.49` |
| top1 | `scalar_u4` | `48` | `0.19` | `192.8` | `9/10` | `10/10` | `20/20` | `0.90` | `0.00917` | `1568.18` |
| top4 | `scalar_u4` | `48` | `0.05` | `723.3` | `9/10` | `10/10` | `20/20` | `0.90` | `0.01090` | `1925.36` |
| top1 | `global_pq_64B` | `64` | `3.50` | `270.0` | `9/10` | `10/10` | `20/20` | `0.90` | `0.00705` | `50.35` |
| top4 | `global_pq_64B` | `64` | `3.50` | `1016.1` | `9/10` | `10/10` | `20/20` | `0.90` | `0.00678` | `150.82` |
| top1 | `global_pq_80B` | `80` | `3.50` | `334.0` | `10/10` | `10/10` | `20/20` | `1.00` | `0.00506` | `62.55` |
| top4 | `global_pq_80B` | `80` | `3.50` | `1257.0` | `10/10` | `10/10` | `20/20` | `1.00` | `0.00493` | `62.49` |
| top1 | `global_pq_96B` | `96` | `3.50` | `398.0` | `10/10` | `10/10` | `20/20` | `1.00` | `0.00155` | `72.76` |
| top4 | `global_pq_96B` | `96` | `3.50` | `1497.8` | `10/10` | `10/10` | `20/20` | `1.00` | `0.00147` | `74.30` |
| top1 | `scalar_u8` | `96` | `0.19` | `384.8` | `10/10` | `10/10` | `20/20` | `1.00` | `0.00053` | `2962.67` |
| top4 | `scalar_u8` | `96` | `0.05` | `1445.9` | `10/10` | `10/10` | `20/20` | `1.00` | `0.00064` | `1974.17` |

Selected cascade rows:

| Selection | Method | Selected-code KiB/query | p50 candidate rows | p50 scan us | p95 scan us | p50 fp32 cascade@50 us | p95 fp32 cascade@50 us | Avg fp32 cascade@50 KiB |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| top1 | `global_pq_32B` | `142.0` | `4096` | `71.83` | `180.62` | `87.90` | `224.00` | `160.9` |
| top4 | `global_pq_32B` | `534.4` | `15958` | `282.00` | `1075.29` | `312.88` | `1191.88` | `553.4` |
| top1 | `global_pq_48B` | `206.0` | `4096` | `113.17` | `357.92` | `130.56` | `417.58` | `224.9` |
| top4 | `global_pq_48B` | `775.3` | `15958` | `449.08` | `1854.92` | `489.02` | `1944.29` | `794.2` |
| top1 | `global_pq_80B` | `334.0` | `4096` | `210.58` | `469.67` | `224.60` | `523.12` | `352.9` |
| top4 | `global_pq_80B` | `1257.0` | `15958` | `839.75` | `1470.04` | `878.73` | `1502.48` | `1275.9` |
| top1 | `scalar_u4` | `192.8` | `4096` | `4649.54` | `12473.62` | `4666.02` | `12517.58` | `211.7` |
| top4 | `scalar_u4` | `723.3` | `15958` | `17796.21` | `36101.79` | `17825.83` | `36184.50` | `742.3` |

Interpretation:

- Dynamic visited rows are a better routing scout than sealed block expansion
  at the same top1 row count, but they are not a storage layout. They show what
  the row route can find before TreeDB decides which fixed blocks to read.
- Global PQ80 is the first lane in this run that clears the strict conditional
  gates `top10@20=10/10`, `top10@50=10/10`, and `top20@50=20/20` for every
  routed query, at `80 B` row code plus `3.50 B/vector` selected metadata.
- Global PQ48 is the more interesting low-byte candidate-generator lane:
  `48 B` row code, low metadata, worst `10/10` top10@50 and `20/20` top20@50,
  but only `8/10` worst top10@20 and `0.80` worst exact rerank@20 recall@10.
- Scalar u4 at the same `48 B` row-code budget has slightly better candidate
  gates than PQ48 in this prototype, but the reconstructed Go scorer is far too
  slow for a hot scan. It remains a quality target for an optimized scalar
  kernel, not a current throughput winner.
- PQ32 is too weak for the strict top10@20/top20@50 frontier, but it does keep
  exact top10 inside approx@50 for every routed query in this dynamic-row pass.
- PQ96 and SQ8 are near-final quality references, but compressed final top10
  still has a worst `9/10` row. Exact rerank remains mandatory.
...
graph-sorted storage blocks, a q0..24 focused graph-visited stress pass over
global PQ/local-residual-PQ lanes, a q0..24 dynamic graph-visited row scout,
and an exact in-cluster graph-visited smoke over exact graph-sorted blocks.
Row-id order is a weak control. IVF/k-means gives the first buildable locality
signal, the sorted-block variants show that a buildable locality order can feed
fixed TreeDB-style storage blocks, and the graph proxies add query-independent
graph locality without claiming full HNSW/TreeDB graph behavior. The
graph-visited scouts now make the routing failure mode explicit: they are closer
to visited-set paths, but still miss winners on hard queries before compression.
The q0..24 block pass shows that top4 graph-visited storage-block routing has
p50-perfect top10/top20 containment, but worst queries still route only `6/10`
top10 and `10/20` top20 winners. The dynamic visited-row scout separates route
quality from block fetch policy: top1 dynamic rows improve p50 top10 routing
from `5/10` to `10/10` at the same `4096`-row budget, but hard query `6` still
routes only `6/10` top10 and `12/20` top20 even in the top4 dynamic row set.
The exact in-cluster graph smoke also shows that stronger locality proxies must
carry build-cost accounting. These results show why codebook stages need real
train/eval splits rather than top100 oracle fits.
...
blocks, and graph-visited selections over sealed graph-sorted blocks, with
broader q0..24 graph-visited coverage for the PQ/local-residual-PQ frontier.
Local residual-PQ improves candidate gates at extra metadata cost; in the
q0..24 graph-visited pass, local residual-PQ48 repairs the conditional worst
top10@20 and rerank@20 gates that global PQ48 misses, but spends about
`10.55 B/vector` more selected metadata. Local residual-OPQ slightly lowers
score error in the q0..9 full ladder but has not yet justified the additional
rotation metadata and build time. The q0..24 dynamic graph-visited row scout
adds a route-quality view where local codebook lanes are intentionally disabled:
global PQ80 is the first row-code budget that clears the strict conditional
top10@20/top10@50/top20@50 gates, while global PQ48 remains the lowest-byte
lane with perfect top10@50 and top20@50 containment but not perfect top10@20.
Track B still needs larger query coverage, larger train/eval slices,
production-grade local OPQ/LOPQ amortization, full HNSW/TreeDB graph visited
sets, and actual TreeDB granule layouts.
...
| Fixed byte-budget comparisons | Top100 and buildable runs cover the 32/48/64/80/96-byte ladder where the lane exists. The q0..9 graph-visited full-ladder scout covers 32/48/64/80/96 for PQ, residual-PQ, OPQ-style, local residual-PQ, and local residual-OPQ lanes, and compares them against local PCA and scalar lanes at the same row-code budgets. The broader q0..24 graph-visited stress pass covers PQ at 32/48/64/80/96 and local residual-PQ at 32/48/64, plus local PCA and scalar baselines. The dynamic graph-visited row scout covers PQ at 32/48/64/80/96 plus scalar u4/u8, with local per-granule lanes disabled because dynamic visited sets are not sealed storage granules. The centroid-routed and graph-routed TreeDB descriptor-granule scouts cover PQ at 32/48/64/80/96 plus local PCA and scalar baselines over actual `ColumnPart.Descriptor.Granules`; the graph-routed descriptor pass also covers local residual-PQ at 32/48/64. The exact graph-neighborhood q0..24 scout covers PQ at 32/48/64/80/96, local residual-PQ at 32/48/64, and matched scalar/local-PCA baselines. The smaller exact in-cluster graph smoke covers only 32/48/64/96 selected rows, so it remains locality/routing instrumentation rather than a full budget ladder. | Satisfied for the measured scout lanes; still partial for production because full HNSW/production graph-neighborhood routing layouts remain unmeasured. |
...
| Production/buildable granule coverage | Measured row-id controls, IVF clusters, IVF-sorted fixed blocks, graph-neighborhood fixed blocks, graph-sorted row-adjacent fixed blocks, a graph-visited block-routing scout over sealed graph-sorted storage blocks, a broader q0..24 graph-visited PQ/local-residual-PQ stress pass, a dynamic q0..24 graph-visited row scout to separate route quality from block expansion, an exact in-cluster graph-visited smoke over exact graph-sorted blocks, q0..24 TreeDB `ColumnPart.Descriptor.Granules` scouts over graph-sorted vector order with both centroid routing and graph-visited routing, and a q0..24 exact graph-neighborhood block scout. | Partial; dynamic visited rows are not sealed storage granules, the descriptor graph route uses an IVF-window row graph and exact query-to-row expansion rather than full HNSW/production graph routing, the exact graph-neighborhood builder is intentionally expensive scout machinery rather than a production graph builder, and full HNSW/TreeDB graph visited sets plus production graph-neighborhood layouts are not measured. |
...
frontier, plus q0..24 actual `ColumnPart.Descriptor.Granules` scouts with
centroid routing and graph-visited routing, and a q0..24 exact graph-neighborhood
block scout. The exact graph-neighborhood proxy materially improves hard-query
routing, but it is expensive scout machinery and still misses winners on the
worst top4 query. The report still has not shown that full HNSW/TreeDB graph
visited sets or production graph-neighborhood layouts preserve the same
candidate-survival frontier. The descriptor graph route is also a negative
result in the current q0..24/32K setup: it does not repair hard queries relative
to centroid-routed descriptor granules. Until those routes are measured, the
current result is a strong research frontier, not a production format decision.
...
q0..24 graph-visited stress confirms routing is the first production gate,
local residual-PQ can repair hard conditional shortlist gates at extra metadata cost,
