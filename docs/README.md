...
- **[TreeDB Text v2 Contract Benchmarks](benchmarks/treedb_text_v2_contract_benchmarks.md)**: #2623 M0 benchmark matrix for isolated text writes, search scale, concurrent serving, counters, profiles, and required baseline evidence.
