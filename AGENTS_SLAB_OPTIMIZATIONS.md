...
- Reopened #7 on `slab-opt-07-value-delta`; MVA is a synthetic xor-delta prototype for fixed-size values.
- Baseline replay (ptr-values, slab-opt-07-value-delta pre-change): 1,088,241,401 / 1,085,060,494 / 1,088,174,706 ns/op.
- Replay after delta prototype (no integration in hot path): 1,090,833,598 / 1,090,922,482 / 1,089,000,815 ns/op.
- CPU profile: `/tmp/treedb_ptrvalues_value_delta_cpu.prof` (pprof top captured).
