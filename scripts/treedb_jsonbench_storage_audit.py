...
def retained_status_summary(result_json: Path | None, data: Any | None = None) -> dict[str, Any]:
    ...
    def inactive(fields: list[dict[str, Any]]) -> bool:
        ...
        for field in fields:
            ...
            if value == "" or "inactive" in value or value in {"none", "not_configured"}:
                return True
        return False
    ...
    return {
        ...
        "retained_payload_encoding_status_missing": not encoding_fields or not encoding_status_fields,
        "retained_payload_encoding_inactive": inactive(encoding_fields) or inactive(encoding_status_fields),
        ...
        "retained_payload_compression_status_missing": not compression_fields or not compression_status_fields,
        "retained_payload_compression_inactive": inactive(compression_fields) or inactive(compression_status_fields),
    }
