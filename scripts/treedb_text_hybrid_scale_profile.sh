...
treedb_performance_env=(TREEDB_LEAF_PAGE_CACHE_ENTRIES TREEDB_COLUMN_STORE_TYPED_COMPRESSION TREEDB_COLUMN_STORE_TYPED_SECTION_COMPRESSION TREEDB_COLUMN_STORE_TYPED_LOCATOR_COMPRESSION TREEDB_COLUMN_STORE_TYPED_DICTIONARY_COMPRESSION TREEDB_COLUMN_STORE_TYPED_PRUNING_COMPRESSION TREEDB_COLUMN_STORE_TYPED_INT64_ENCODING TREEDB_COLUMN_STORE_TYPED_ROWS_PER_GRANULE TREEDB_COLUMN_STORE_TYPED_ADAPTIVE_ENABLED TREEDB_COLUMN_STORE_TYPED_ADAPTIVE_TARGET_BYTES TREEDB_COLUMN_STORE_TYPED_ADAPTIVE_MIN_ROWS TREEDB_COLUMN_STORE_TYPED_ADAPTIVE_MAX_ROWS TREEDB_DEBUG_COMMIT_TIMING TREEDB_DEBUG_BATCH_SET_CALLER_SAMPLE_MOD TREEDB_DEBUG_DB_GET_CALLER_SAMPLE_MOD TREEDB_DEBUG_SNAPSHOT_GET_CALLER_SAMPLE_MOD TREEDB_DEBUG_VLOG_TIMINGS TREEDB_DEBUG_VLOG_TIMINGS_MIN_MS TREEDB_DEBUG_VLOG_TIMINGS_BUDGET TREEDB_DEBUG_MEMTABLE_ROTATE TREEDB_DEBUG_MEMTABLE_ROTATE_BUDGET TREEDB_DEBUG_VLOG_SHAPE TREEDB_DEBUG_VLOG_SHAPE_DISK TREEDB_DEBUG_VLOG_SHAPE_INTERVAL_MS TREEDB_DEBUG_VLOG_SHAPE_BUDGET TREEDB_DEBUG_VLOG_MAINT TREEDB_DEBUG_VLOG_MAINT_BUDGET TREEDB_OUTER_LEAF_READ_SAMPLE_MOD TREEDB_HOT_PATH_STATS TREEDB_VLOG_MAX_DEAD_MAPPINGS TREEDB_VLOG_ADAPTIVE_DEAD_MAPPINGS TREEDB_VLOG_ENABLE_CURRENT_WRITABLE_MMAP TREEDB_VLOG_ENABLE_CURRENT_LEAF_WRITABLE_MMAP TREEDB_VLOG_CURRENT_WRITABLE_MMAP_TARGET_BYTES TREEDB_VLOG_MAX_MAPPED_SEALED_SEGMENTS TREEDB_VLOG_MAX_MAPPED_SEALED_BYTES TREEDB_VLOG_MAX_MAPPED_LEAF_SEALED_SEGMENTS TREEDB_VLOG_MAX_MAPPED_LEAF_SEALED_BYTES)
