...
-----------  ----------------  -------------------------------
Batch Write         5,001,701                        2,788,432
```
...
-----------  ----------------  -------------------------------
Batch Write            9.17ms                           9.10ms
  After Run            9.23ms                           9.31ms
```

## Disk Usage (End of Run)

```text
TreeDB (backend command_wal_v1): total=670 KiB files=6

TreeDB (backend): total=512 KiB files=4
```
