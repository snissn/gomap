...
batches of at most 256 sources, 41 text generations, 0.503 s source/chunk wall,
88,539,136-byte peak RSS, and 41,156,982 WAL-excluded physical bytes. Against
...
maintenance rows bind observed deletion tombstone debt. Every source row records
