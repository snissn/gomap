...
Source: `2a4ad65bc23922ece1787b67a4fa12114a02789a` / tree `a0f28c839c4718d19b37fa78fb4f3f52853bdd9f`; retained qualification eligible: **TRUE**.
...
| --- | --- | ---: | ---: | ---: | --- |
| Apache Lucene | common | 0.408 ms | 1.665 ms | 2.041 ms | `32055f75762e1bc6d5caf948100d7005401d8ea6d53bfda1e0d45ad4f13efd40` |
| Apache Lucene | rare | 0.216 ms | 0.272 ms | 0.827 ms | `d1e8f7e714d80caa330129cd3ef396355c46b9eda93e8ceeaae231865bd1aee0` |
| Apache Lucene | and | 0.275 ms | 1.185 ms | 3.464 ms | `ec83fcd96024576cbb2628ca36dd60d1bdf129216c6d71b8d5e7a44a5065953d` |
| Apache Lucene | or | 0.255 ms | 1.048 ms | 2.579 ms | `d3a21b7de5119f9bf360bf76da508e0778a2ddb502717efdcc4d4abd0b0ca9d8` |
| Apache Lucene | phrase | 0.368 ms | 0.916 ms | 3.744 ms | `8088cbb0b34ee919fde96c27663d90a54e722216b390e032842cdc7ae04d5696` |
| Apache Lucene | scalar_filtered | 0.198 ms | 0.262 ms | 1.000 ms | `efbd9f605d29312de95b30ea2d42e875a7e9c79acbfabe73748ed2b115672fa0` |
| TreeDB text-v2 | common | 0.245 ms | 0.474 ms | 0.812 ms | `32055f75762e1bc6d5caf948100d7005401d8ea6d53bfda1e0d45ad4f13efd40` |
| TreeDB text-v2 | rare | 0.019 ms | 0.029 ms | 0.029 ms | `d1e8f7e714d80caa330129cd3ef396355c46b9eda93e8ceeaae231865bd1aee0` |
| TreeDB text-v2 | and | 0.016 ms | 0.019 ms | 0.035 ms | `ec83fcd96024576cbb2628ca36dd60d1bdf129216c6d71b8d5e7a44a5065953d` |
| TreeDB text-v2 | or | 0.018 ms | 0.037 ms | 0.041 ms | `d3a21b7de5119f9bf360bf76da508e0778a2ddb502717efdcc4d4abd0b0ca9d8` |
| TreeDB text-v2 | phrase | 0.036 ms | 0.084 ms | 0.117 ms | `8088cbb0b34ee919fde96c27663d90a54e722216b390e032842cdc7ae04d5696` |
| TreeDB text-v2 | scalar_filtered | 0.037 ms | 0.280 ms | 0.324 ms | `efbd9f605d29312de95b30ea2d42e875a7e9c79acbfabe73748ed2b115672fa0` |

## Directional native-scoring latency (not semantically equivalent)

| engine | case | p50 | p95 | p99 | disposition |
| --- | --- | ---: | ---: | ---: | --- |
| Bleve | common | 0.358 ms | 0.388 ms | 0.408 ms | Bleve v2.4.4 native TF-IDF scorer does not implement the pinned BM25F formula |
| Bleve | rare | 0.004 ms | 0.023 ms | 0.053 ms | Bleve v2.4.4 native TF-IDF scorer does not implement the pinned BM25F formula |
| Bleve | and | 0.005 ms | 0.008 ms | 0.009 ms | Bleve v2.4.4 native TF-IDF scorer does not implement the pinned BM25F formula |
| Bleve | or | 0.008 ms | 0.012 ms | 0.016 ms | Bleve v2.4.4 native TF-IDF scorer does not implement the pinned BM25F formula |
| Bleve | phrase | 0.020 ms | 0.027 ms | 0.033 ms | Bleve v2.4.4 native TF-IDF scorer does not implement the pinned BM25F formula |
| SQLite FTS5 | common | 2.015 ms | 2.054 ms | 2.065 ms | SQLite FTS5 native bm25() IDF and floor do not implement the pinned BM25F formula |
| SQLite FTS5 | rare | 0.018 ms | 0.019 ms | 0.023 ms | SQLite FTS5 native bm25() IDF and floor do not implement the pinned BM25F formula |
...
| SQLite FTS5 | phrase | 0.028 ms | 0.029 ms | 0.030 ms | SQLite FTS5 native bm25() IDF and floor do not implement the pinned BM25F formula |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| Bleve | 0.622, 0.629, 0.619 | 16081.6, 15901.0, 16145.3 | 0.566 s, 0.569 s, 0.575 s | 331.469 MiB, 340.266 MiB, 337.203 MiB | 10573861, 10573283, 10573775 | 0, 0, 0 | 0, 0, 0 |
| Apache Lucene | 1.208, 1.231, 1.235 | 8280.9, 8125.4, 8097.9 | 1.141 s, 1.215 s, 1.218 s | unsupported: Standard Java process APIs do not expose process-lifetime peak RSS, unsupported: Standard Java process APIs do not expose process-lifetime peak RSS, unsupported: Standard Java process APIs do not expose process-lifetime peak RSS | 335311, 335311, 335311 | 0, 0, 0 | 0, 0, 0 |
| SQLite FTS5 | 0.055, 0.056, 0.059 | 181884.6, 177027.4, 168353.8 | 0.045 s, 0.045 s, 0.047 s | 50.812 MiB, 50.859 MiB, 50.781 MiB | 3915776, 3915776, 3915776 | 0, 0, 0 | 0, 0, 0 |
| TreeDB text-v2 | 0.217, 0.175, 0.176 | 45998.1, 57007.0, 56721.0 | 0.131 s, 0.127 s, 0.123 s | 82.531 MiB, 84.484 MiB, 83.328 MiB | 6553974, 6553974, 6553974 | 0, 0, 0 | 0, 0, 0 |
...
- Versions: `{"go": "go1.26.0", "module": "2a4ad65bc23922ece1787b67a4fa12114a02789a", "platform": "darwin/arm64"}`
