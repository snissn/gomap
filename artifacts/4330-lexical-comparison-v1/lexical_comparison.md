...
Source: `5920f1209dcb52ab5339e7fa39e9b2f38080a68b` / tree `d670eeab60465e2a72ab7f479a8e5de21261d371`; retained qualification eligible: **TRUE**.
...
| --- | --- | ---: | ---: | ---: | --- |
| Apache Lucene | common | 0.413 ms | 1.686 ms | 2.027 ms | `32055f75762e1bc6d5caf948100d7005401d8ea6d53bfda1e0d45ad4f13efd40` |
| Apache Lucene | rare | 0.214 ms | 0.267 ms | 0.866 ms | `d1e8f7e714d80caa330129cd3ef396355c46b9eda93e8ceeaae231865bd1aee0` |
| Apache Lucene | and | 0.273 ms | 1.180 ms | 3.421 ms | `ec83fcd96024576cbb2628ca36dd60d1bdf129216c6d71b8d5e7a44a5065953d` |
| Apache Lucene | or | 0.256 ms | 1.028 ms | 2.602 ms | `d3a21b7de5119f9bf360bf76da508e0778a2ddb502717efdcc4d4abd0b0ca9d8` |
| Apache Lucene | phrase | 0.357 ms | 0.615 ms | 4.169 ms | `8088cbb0b34ee919fde96c27663d90a54e722216b390e032842cdc7ae04d5696` |
| Apache Lucene | scalar_filtered | 0.198 ms | 0.222 ms | 0.861 ms | `efbd9f605d29312de95b30ea2d42e875a7e9c79acbfabe73748ed2b115672fa0` |
| TreeDB text-v2 | common | 0.274 ms | 0.502 ms | 0.553 ms | `32055f75762e1bc6d5caf948100d7005401d8ea6d53bfda1e0d45ad4f13efd40` |
| TreeDB text-v2 | rare | 0.012 ms | 0.013 ms | 0.015 ms | `d1e8f7e714d80caa330129cd3ef396355c46b9eda93e8ceeaae231865bd1aee0` |
| TreeDB text-v2 | and | 0.017 ms | 0.019 ms | 0.021 ms | `ec83fcd96024576cbb2628ca36dd60d1bdf129216c6d71b8d5e7a44a5065953d` |
| TreeDB text-v2 | or | 0.019 ms | 0.038 ms | 0.040 ms | `d3a21b7de5119f9bf360bf76da508e0778a2ddb502717efdcc4d4abd0b0ca9d8` |
| TreeDB text-v2 | phrase | 0.051 ms | 0.061 ms | 1.029 ms | `8088cbb0b34ee919fde96c27663d90a54e722216b390e032842cdc7ae04d5696` |
| TreeDB text-v2 | scalar_filtered | 0.038 ms | 0.281 ms | 0.655 ms | `efbd9f605d29312de95b30ea2d42e875a7e9c79acbfabe73748ed2b115672fa0` |

## Directional native-scoring latency (not semantically equivalent)

| engine | case | p50 | p95 | p99 | disposition |
| --- | --- | ---: | ---: | ---: | --- |
| Bleve | common | 0.366 ms | 0.401 ms | 0.409 ms | Bleve v2.4.4 native TF-IDF scorer does not implement the pinned BM25F formula |
| Bleve | rare | 0.003 ms | 0.013 ms | 0.065 ms | Bleve v2.4.4 native TF-IDF scorer does not implement the pinned BM25F formula |
| Bleve | and | 0.006 ms | 0.010 ms | 0.019 ms | Bleve v2.4.4 native TF-IDF scorer does not implement the pinned BM25F formula |
| Bleve | or | 0.008 ms | 0.012 ms | 0.165 ms | Bleve v2.4.4 native TF-IDF scorer does not implement the pinned BM25F formula |
| Bleve | phrase | 0.021 ms | 0.033 ms | 0.039 ms | Bleve v2.4.4 native TF-IDF scorer does not implement the pinned BM25F formula |
| SQLite FTS5 | common | 1.965 ms | 2.010 ms | 2.046 ms | SQLite FTS5 native bm25() IDF and floor do not implement the pinned BM25F formula |
| SQLite FTS5 | rare | 0.018 ms | 0.018 ms | 0.018 ms | SQLite FTS5 native bm25() IDF and floor do not implement the pinned BM25F formula |
| SQLite FTS5 | and | 0.021 ms | 0.022 ms | 0.025 ms | SQLite FTS5 native bm25() IDF and floor do not implement the pinned BM25F formula |
| SQLite FTS5 | or | 0.031 ms | 0.033 ms | 0.037 ms | SQLite FTS5 native bm25() IDF and floor do not implement the pinned BM25F formula |
| SQLite FTS5 | phrase | 0.027 ms | 0.029 ms | 0.033 ms | SQLite FTS5 native bm25() IDF and floor do not implement the pinned BM25F formula |
| SQLite FTS5 | scalar_filtered | 0.021 ms | 0.021 ms | 0.024 ms | SQLite FTS5 native bm25() IDF and floor do not implement the pinned BM25F formula |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| Bleve | 0.710, 0.645, 0.621 | 14082.9, 15497.3, 16101.7 | 0.599 s, 0.582 s, 0.576 s | 330.969 MiB, 327.438 MiB, 342.078 MiB | 10573511, 10573757, 10573837 | 0, 0, 0 | 0, 0, 0 |
| Apache Lucene | 1.368, 1.248, 1.240 | 7308.9, 8011.5, 8066.4 | 1.192 s, 1.211 s, 1.215 s | unsupported: Standard Java process APIs do not expose process-lifetime peak RSS, unsupported: Standard Java process APIs do not expose process-lifetime peak RSS, unsupported: Standard Java process APIs do not expose process-lifetime peak RSS | 335311, 335311, 335311 | 0, 0, 0 | 0, 0, 0 |
| SQLite FTS5 | 0.063, 0.069, 0.067 | 159583.6, 144138.3, 148311.5 | 0.046 s, 0.049 s, 0.047 s | 50.984 MiB, 50.766 MiB, 50.922 MiB | 3915776, 3915776, 3915776 | 0, 0, 0 | 0, 0, 0 |
| TreeDB text-v2 | 0.223, 0.269, 0.264 | 44746.1, 37128.9, 37877.3 | 0.119 s, 0.136 s, 0.130 s | 78.984 MiB, 84.672 MiB, 81.359 MiB | 6553974, 6553974, 6553974 | 0, 0, 0 | 0, 0, 0 |
...
- Versions: `{"go": "go1.26.0", "module": "5920f1209dcb52ab5339e7fa39e9b2f38080a68b", "platform": "darwin/arm64"}`
