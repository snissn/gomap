...
func TestEveryRegisterableInventoryFieldHasConcreteExactHandleProducer(t *testing.T) {
	producers := map[rootpublication.ReachabilityField]exactHandleProducer{
		...
		rootpublication.ReachabilityMetaPage:                   db.NewStableDBResourceToken,
		rootpublication.ReachabilityUserRoot:                   db.NewStableDBResourceToken,
		rootpublication.ReachabilitySystemRoot:                 db.NewStableDBResourceToken,
		rootpublication.ReachabilityFreelist:                   db.NewStableDBResourceToken,
		...
		rootpublication.ReachabilityCollectionSystemRoot:       collections.NewStableCollectionResourceToken,
		rootpublication.ReachabilityCollectionPrimaryRoot:      collections.NewStableCollectionResourceToken,
		rootpublication.ReachabilityCollectionTemplateRoot:     collections.NewStableCollectionResourceToken,
		rootpublication.ReachabilityCollectionIndexStateRoot:   collections.NewStableCollectionResourceToken,
		rootpublication.ReachabilityCollectionColumnRoot:       collections.NewStableCollectionResourceToken,
		rootpublication.ReachabilityCollectionSecondaryRoot:    collections.NewStableCollectionResourceToken,
		rootpublication.ReachabilityCollectionVectorRoot:       collections.NewStableCollectionResourceToken,
		rootpublication.ReachabilityCollectionTextDictionary:   collections.NewStableCollectionResourceToken,
		rootpublication.ReachabilityCollectionTextPosting:      collections.NewStableCollectionResourceToken,
		rootpublication.ReachabilityCollectionTextPosition:     collections.NewStableCollectionResourceToken,
