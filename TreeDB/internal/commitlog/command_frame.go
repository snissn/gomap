...
// caller's operation source twice: once for sizing/validation and once for
// encoding. It avoids materializing a []RawKVOperation when the caller already
// owns a replayable batch representation.
