...
func buildRows() []Row {
	...
	add(quarantined("commitlog.ExternalRefClass.ExternalRefPayloadFile", "command WAL external ref", "payload side file", "#3677", "the frame encoder and decoder reject this reserved class until it has identity, sync, recovery, and deletion ownership"))
