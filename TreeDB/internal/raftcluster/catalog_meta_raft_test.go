...
func TestCatalogMetaRaftProviderCommitsOnlyAfterLeaderApplyAndSnapshots(t *testing.T) {
	...
	for _, source := range []CatalogMetaReadSourceV1{CatalogMetaReadSourceStrictSearchV1, CatalogMetaReadSourceCoordinatorLifecycleV1, CatalogMetaReadSourceShardLifecycleV1, CatalogMetaReadSourceUnknownV1} {
	...
	if stats.Total.Reads != 5 || stats.Total.Successes != 5 || stats.Total.Failures != 0 || stats.Total.VerifyLeaderCalls != 5 || stats.Total.LogBarriers != 0 || stats.Total.NoLogProofs != 5 || stats.OperationsHealth.Reads != 1 || stats.StrictSearch.Reads != 1 || stats.CoordinatorLifecycle.Reads != 1 || stats.ShardLifecycle.Reads != 1 || stats.Unknown.Reads != 1 || stats.LastTerm == 0 || stats.LastCatalogApplied != index || stats.LastRaftApplied < index || stats.LastRaftLog < index {
