# Addendum A: Testing Specification v2.4 (Updated for RFC Compliance)
...
* **Recovery:**
    ...
    * **Leaf Link Integrity:** Verify `PrevLeafID` and `NextLeafID` chains are not broken.
