...
func (db *DB) PlanFlushSpanRun(req FlushSpanRunPlanRequest) (FlushSpanRunMetadata, error) {
	meta, prepared, err := db.prepareFlushSpanRun(req)
	if err != nil {
		return meta, err
	}
...
func (db *DB) prepareFlushSpanRun(req FlushSpanRunPlanRequest) (FlushSpanRunMetadata, zipper.ReadOnlyPrepareResult, error) {
