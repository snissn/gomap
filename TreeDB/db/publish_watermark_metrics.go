...
type orderedRootDeltaGroupPublishStats struct {
	...
	rootApplyReadOnlyPrepareWorkerTargets         uint64
	rootApplyReadOnlyPrepareWorkerRanges          uint64
	rootApplyReadOnlyPrepareWorkerRangeMinOps     uint64
	rootApplyReadOnlyPrepareWorkerRangeMaxOps     uint64
	rootApplyReadOnlyPrepareWorkerRangeSingleSpan uint64
...
func (db *DB) observeOrderedRootDeltaGroupPublish(wait, hold time.Duration, roots int, phases orderedRootDeltaGroupPublishPhaseStats, err error) {
	...
	db.orderedRootDeltaGroupRootApplyReadOnlyPrepareWorkerTargets.Add(phases.rootApplyReadOnlyPrepareWorkerTargets)
	db.orderedRootDeltaGroupRootApplyReadOnlyPrepareWorkerRanges.Add(phases.rootApplyReadOnlyPrepareWorkerRanges)
	db.orderedRootDeltaGroupRootApplyReadOnlyPrepareWorkerRangeMinOps.Add(phases.rootApplyReadOnlyPrepareWorkerRangeMinOps)
	db.orderedRootDeltaGroupRootApplyReadOnlyPrepareWorkerRangeMaxOps.Add(phases.rootApplyReadOnlyPrepareWorkerRangeMaxOps)
	db.orderedRootDeltaGroupRootApplyReadOnlyPrepareWorkerRangeSingleSpan.Add(phases.rootApplyReadOnlyPrepareWorkerRangeSingleSpan)
...
func (db *DB) orderedRootDeltaGroupPublishStats() orderedRootDeltaGroupPublishStats {
	...
	stats := orderedRootDeltaGroupPublishStats{
		...
		rootApplyReadOnlyPrepareWorkerTargets:         db.orderedRootDeltaGroupRootApplyReadOnlyPrepareWorkerTargets.Load(),
		rootApplyReadOnlyPrepareWorkerRanges:          db.orderedRootDeltaGroupRootApplyReadOnlyPrepareWorkerRanges.Load(),
		rootApplyReadOnlyPrepareWorkerRangeMinOps:     db.orderedRootDeltaGroupRootApplyReadOnlyPrepareWorkerRangeMinOps.Load(),
		rootApplyReadOnlyPrepareWorkerRangeMaxOps:     db.orderedRootDeltaGroupRootApplyReadOnlyPrepareWorkerRangeMaxOps.Load(),
		rootApplyReadOnlyPrepareWorkerRangeSingleSpan: db.orderedRootDeltaGroupRootApplyReadOnlyPrepareWorkerRangeSingleSpan.Load(),
