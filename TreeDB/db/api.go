...
func (db *DB) Stats() map[string]string {
	...
	stats["treedb.publish.ordered_root_delta_group.root_apply_readonly_prepare_worker_targets_total"] = fmt.Sprintf("%d", orderedDeltaStats.rootApplyReadOnlyPrepareWorkerTargets)
	stats["treedb.publish.ordered_root_delta_group.root_apply_readonly_prepare_worker_ranges_total"] = fmt.Sprintf("%d", orderedDeltaStats.rootApplyReadOnlyPrepareWorkerRanges)
	stats["treedb.publish.ordered_root_delta_group.root_apply_readonly_prepare_worker_range_min_ops_total"] = fmt.Sprintf("%d", orderedDeltaStats.rootApplyReadOnlyPrepareWorkerRangeMinOps)
	stats["treedb.publish.ordered_root_delta_group.root_apply_readonly_prepare_worker_range_max_ops_total"] = fmt.Sprintf("%d", orderedDeltaStats.rootApplyReadOnlyPrepareWorkerRangeMaxOps)
	stats["treedb.publish.ordered_root_delta_group.root_apply_readonly_prepare_worker_range_single_span_total"] = fmt.Sprintf("%d", orderedDeltaStats.rootApplyReadOnlyPrepareWorkerRangeSingleSpan)
