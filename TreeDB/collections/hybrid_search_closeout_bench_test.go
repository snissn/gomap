...
func hybridCloseoutReportStats2506(b *testing.B, response HybridSearchResponse) {
	...
	b.ReportMetric(float64(response.Stats.TextPostingBlocksVisited), "text_blocks_visited/search")
	b.ReportMetric(float64(response.Stats.TextPostingBlocksSkipped), "text_blocks_skipped/search")
