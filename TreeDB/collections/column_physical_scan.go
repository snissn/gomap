...
func (c *Collection) prepareColumnPhysicalScanSnapshotViewAtSnapshot(
	...
	manifest, refs, graphRefs, mutationParts, manifestRecords, err := loadColumnManifestSnapshotViewForScanFromRoot(snap, rootID, cfg, *cfg.ActiveManifest, collectionName, true, catalog.meta.VectorIndexes)
	if err != nil {
