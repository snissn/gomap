...
var typedStorageLegacyNameAllowlist = []typedStorageLegacyNameAllowlistEntry{
	...
	{path: "TreeDB/collections/column_store_test.go", classification: typedStorageLegacyCompatibility, matchingLines: 253, occurrences: 323},
	...
	{path: "TreeDB/collections/typed_column_adapter.go", classification: typedStorageLegacyCompatibility, matchingLines: 93, occurrences: 97},
	...
	{path: "TreeDB/collections/typed_column_benchmark_policy.go", classification: typedStorageLegacyCompatibility, matchingLines: 8, occurrences: 9},
	...
	{path: "TreeDB/collections/typed_column_codec_policy_test.go", classification: typedStorageLegacyCompatibility, matchingLines: 51, occurrences: 59},
