...
var typedStorageLegacyNameAllowlist = []typedStorageLegacyNameAllowlistEntry{
	...
	{path: "TreeDB/collections/typed_column_adapter.go", classification: typedStorageLegacyCompatibility, matchingLines: 38, occurrences: 43},
	{path: "TreeDB/collections/typed_column_adapter_test.go", classification: typedStorageLegacyCompatibility, matchingLines: 187, occurrences: 193},
