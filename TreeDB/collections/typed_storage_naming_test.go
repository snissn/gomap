...
var typedStorageLegacyNameAllowlist = []typedStorageLegacyNameAllowlistEntry{
	...
	{path: "TreeDB/collections/stable_resource_windows_test.go", classification: typedStorageLegacyCompatibility, matchingLines: 5, occurrences: 5},
	{path: "TreeDB/collections/standalone_column_authority.go", classification: typedStorageLegacyCompatibility, matchingLines: 2, occurrences: 2},
	{path: "TreeDB/collections/standalone_column_authority_test.go", classification: typedStorageLegacyCompatibility, matchingLines: 5, occurrences: 5},
	...
	{path: "TreeDB/collections/vector_index_rebuild.go", classification: typedStorageLegacyDerived, matchingLines: 18, occurrences: 20},
