...
var typedStorageLegacyNameAllowlist = []typedStorageLegacyNameAllowlistEntry{
	...
	{path: "TreeDB/collections/column_vector_index_state_manifest_test.go", classification: typedStorageLegacyDerived, matchingLines: 12, occurrences: 16},
	...
	{path: "TreeDB/collections/typed_column_direct_view_contract.go", classification: typedStorageLegacyCompatibility, matchingLines: 29, occurrences: 29},
	...
	{path: "TreeDB/docs/spec/typed-storage-naming.md", classification: typedStorageLegacyCompatibility, matchingLines: 25, occurrences: 30},
