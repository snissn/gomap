...
var typedStorageLegacyNameAllowlist = []typedStorageLegacyNameAllowlistEntry{
	...
	{path: "TreeDB/collections/vector_index_rebuild.go", classification: typedStorageLegacyDerived, matchingLines: 20, occurrences: 22},
	...
	{path: "TreeDB/docs/guides/document-chunking.md", classification: typedStorageLegacyCompatibility, matchingLines: 1, occurrences: 1},
