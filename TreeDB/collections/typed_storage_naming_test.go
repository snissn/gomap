...
var typedStorageLegacyNameAllowlist = []typedStorageLegacyNameAllowlistEntry{
	...
	{path: "TreeDB/collections/column_asset_empty_gc_test.go", classification: typedStorageLegacyCompatibility, matchingLines: 5, occurrences: 5},
	{path: "TreeDB/collections/column_asset_allocator_reuse_test.go", classification: typedStorageLegacyCompatibility, matchingLines: 4, occurrences: 5},
	{path: "TreeDB/collections/column_asset_allocator_bench_test.go", classification: typedStorageLegacyCompatibility, matchingLines: 1, occurrences: 2},
	{path: "TreeDB/collections/column_asset_gc.go", classification: typedStorageLegacyCompatibility, matchingLines: 5, occurrences: 5},
	{path: "TreeDB/collections/column_asset_replay_floor_test.go", classification: typedStorageLegacyCompatibility, matchingLines: 11, occurrences: 11},
	{path: "TreeDB/collections/typed_graph_work_epoch_test.go", classification: typedStorageLegacyCompatibility, matchingLines: 1, occurrences: 1},
	...
	{path: "TreeDB/collections/column_asset_lifecycle_test.go", classification: typedStorageLegacyCompatibility, matchingLines: 1, occurrences: 1},
	{path: "TreeDB/collections/column_asset_manager.go", classification: typedStorageLegacyCompatibility, matchingLines: 32, occurrences: 53},
	...
	{path: "TreeDB/collections/column_asset_segment_bound_test.go", classification: typedStorageLegacyCompatibility, matchingLines: 3, occurrences: 3},
	...
	{path: "TreeDB/collections/column_hnsw_search_pack_reader.go", classification: typedStorageLegacyDerived, matchingLines: 5, occurrences: 5},
	{path: "TreeDB/collections/column_hnsw_search_pack_test.go", classification: typedStorageLegacyDerived, matchingLines: 6, occurrences: 7},
	{path: "TreeDB/collections/column_hnsw_search_pack_writer.go", classification: typedStorageLegacyDerived, matchingLines: 6, occurrences: 6},
	...
	// Q2's holder-owned scalar-u8 loader reaches the published typed-column
	// asset authority through the compatibility-retained configuration API.
	{path: "TreeDB/collections/column_vector_graph_shared_prepared.go", classification: typedStorageLegacyCompatibility, matchingLines: 3, occurrences: 3},
	...
	{path: "TreeDB/collections/column_manifest_format.go", classification: typedStorageLegacyCompatibility, matchingLines: 4, occurrences: 4},
	...
	{path: "TreeDB/collections/cosine_normalized_f32.go", classification: typedStorageLegacyCompatibility, matchingLines: 2, occurrences: 2},
	{path: "TreeDB/collections/cosine_normalized_f32_admission_test.go", classification: typedStorageLegacyCompatibility, matchingLines: 7, occurrences: 9},
	{path: "TreeDB/collections/typed_graph_quantized_rerank_bench_test.go", classification: typedStorageLegacyCompatibility, matchingLines: 2, occurrences: 2},
	...
	{path: "TreeDB/collections/typed_graph_publication.go", classification: typedStorageLegacyCompatibility, matchingLines: 2, occurrences: 3},
	...
	{path: "TreeDB/collections/column_physical_typed_column_sortkey_1948_test.go", classification: typedStorageLegacyCompatibility, matchingLines: 52, occurrences: 60},
	...
	{path: "TreeDB/collections/column_physical_row_reader.go", classification: typedStorageLegacyDeferred, matchingLines: 40, occurrences: 65},
	...
	{path: "TreeDB/collections/prepared_insert.go", classification: typedStorageLegacyCompatibility, matchingLines: 13, occurrences: 22},
	{path: "TreeDB/collections/prepared_insert_test.go", classification: typedStorageLegacyCompatibility, matchingLines: 1, occurrences: 1},
	...
	{path: "TreeDB/documentservice/typed_get_many_test.go", classification: typedStorageLegacyCompatibility, matchingLines: 2, occurrences: 2},
	{path: "TreeDB/documentservice/typed_input.go", classification: typedStorageLegacyCompatibility, matchingLines: 10, occurrences: 10},
	{path: "TreeDB/documentservice/typed_input_test.go", classification: typedStorageLegacyCompatibility, matchingLines: 1, occurrences: 1},
	{path: "TreeDB/documentservice/service.go", classification: typedStorageLegacyCompatibility, matchingLines: 13, occurrences: 17},
	...
	{path: "TreeDB/collections/column_vector_graph_document_id_state.go", classification: typedStorageLegacyDerived, matchingLines: 29, occurrences: 32},
	{path: "TreeDB/collections/column_vector_graph_inv_norm_state.go", classification: typedStorageLegacyDerived, matchingLines: 27, occurrences: 30},
	...
	{path: "TreeDB/collections/column_vector_graph_adjacency_state_source.go", classification: typedStorageLegacyDerived, matchingLines: 8, occurrences: 8},
	...
	{path: "TreeDB/collections/column_vector_graph_row_reader.go", classification: typedStorageLegacyDerived, matchingLines: 13, occurrences: 14},
	...
	{path: "TreeDB/collections/column_vector_graph_row_ref_state.go", classification: typedStorageLegacyDerived, matchingLines: 36, occurrences: 39},
	...
	{path: "TreeDB/collections/column_vector_graph_typed_column.go", classification: typedStorageLegacyDerived, matchingLines: 8, occurrences: 8},
	...
	{path: "TreeDB/collections/column_physical_asset_bound_test.go", classification: typedStorageLegacyCompatibility, matchingLines: 8, occurrences: 13},
	{path: "TreeDB/collections/typed_graph_asset_encoded_bound.go", classification: typedStorageLegacyCompatibility, matchingLines: 1, occurrences: 1},
	{path: "TreeDB/collections/typed_graph_buffered_encoded_bound.go", classification: typedStorageLegacyCompatibility, matchingLines: 1, occurrences: 2},
	{path: "TreeDB/collections/typed_graph_fold_prepare.go", classification: typedStorageLegacyCompatibility, matchingLines: 4, occurrences: 4},
	...
	{path: "TreeDB/collections/typed_graph_fold_reopen_test.go", classification: typedStorageLegacyCompatibility, matchingLines: 8, occurrences: 8},
	...
	{path: "TreeDB/collections/column_vector_graph_quantized_asset.go", classification: typedStorageLegacyDerived, matchingLines: 114, occurrences: 128},
	...
	{path: "TreeDB/collections/vector_index_rebuild.go", classification: typedStorageLegacyDerived, matchingLines: 26, occurrences: 28},
