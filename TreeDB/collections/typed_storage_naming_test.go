...
var typedStorageLegacyNameAllowlist = []typedStorageLegacyNameAllowlistEntry{
	...
	{path: "TreeDB/collections/column_asset_manager.go", classification: typedStorageLegacyCompatibility, matchingLines: 29, occurrences: 50},
	...
	{path: "TreeDB/collections/stable_resource_inventory_test.go", classification: typedStorageLegacyCompatibility, matchingLines: 13, occurrences: 13},
	{path: "TreeDB/collections/stable_resource_windows_test.go", classification: typedStorageLegacyCompatibility, matchingLines: 2, occurrences: 2},
