...
var typedStorageLegacyNameAllowlist = []typedStorageLegacyNameAllowlistEntry{
	...
	{path: "TreeDB/collections/column_asset_manager.go", classification: typedStorageLegacyCompatibility, matchingLines: 25, occurrences: 46},
	...
	{path: "TreeDB/collections/query_ready_generation_open_test.go", classification: typedStorageLegacyCompatibility, matchingLines: 14, occurrences: 14},
