...
var typedStorageLegacyNameAllowlist = []typedStorageLegacyNameAllowlistEntry{
	...
	{path: "TreeDB/collections/column_asset_manager.go", classification: typedStorageLegacyCompatibility, matchingLines: 16, occurrences: 18},
	...
	{path: "TreeDB/collections/column_asset_rewrite_test.go", classification: typedStorageLegacyCompatibility, matchingLines: 22, occurrences: 22},
	...
	{path: "TreeDB/collections/column_physical_scan.go", classification: typedStorageLegacyDeferred, matchingLines: 36, occurrences: 36},
	...
	{path: "TreeDB/collections/column_reconstruction.go", classification: typedStorageLegacyCompatibility, matchingLines: 27, occurrences: 28},
	...
	{path: "TreeDB/collections/column_store.go", classification: typedStorageLegacyCompatibility, matchingLines: 76, occurrences: 122},
	...
	{path: "TreeDB/collections/column_store_test.go", classification: typedStorageLegacyCompatibility, matchingLines: 201, occurrences: 258},
	...
	{path: "TreeDB/collections/column_vector_graph_adjacency_source.go", classification: typedStorageLegacyDerived, matchingLines: 22, occurrences: 25},
	{path: "TreeDB/collections/column_vector_graph_adjacency_direct_source.go", classification: typedStorageLegacyDerived, matchingLines: 3, occurrences: 3},
	...
	{path: "TreeDB/collections/typed_column_adapter.go", classification: typedStorageLegacyCompatibility, matchingLines: 51, occurrences: 57},
	{path: "TreeDB/collections/typed_column_adapter_test.go", classification: typedStorageLegacyCompatibility, matchingLines: 244, occurrences: 252},
	...
	{path: "TreeDB/collections/typed_column_direct_view_conformance_test.go", classification: typedStorageLegacyCompatibility, matchingLines: 75, occurrences: 101},
	{path: "TreeDB/collections/typed_column_direct_view_contract.go", classification: typedStorageLegacyCompatibility, matchingLines: 30, occurrences: 30},
	...
	{path: "TreeDB/collections/typed_column_offsets_list_test.go", classification: typedStorageLegacyCompatibility, matchingLines: 8, occurrences: 8},
	...
	{path: "TreeDB/collections/typed_storage_layout.go", classification: typedStorageLegacyCompatibility, matchingLines: 16, occurrences: 22},
	...
	{path: "TreeDB/collections/vector_index_rebuild_test.go", classification: typedStorageLegacyDerived, matchingLines: 33, occurrences: 39},
	...
	{path: "TreeDB/docs/spec/storage-format.md", classification: typedStorageLegacyDeferred, matchingLines: 1, occurrences: 2},
