...
func newColumnVectorGraphStableResourceAccumulator(registry *rootpublication.IdentityPinRegistry) (*columnVectorGraphStableResourceAccumulator, error) {
	...
	if !rootpublication.StableRelativeNamespaceSupported() {
		return nil, fmt.Errorf("%w: column vector rebuild stable authority requires exact relative namespace persistence", rootpublication.ErrNamespacePersistenceUnsupported)
	}
