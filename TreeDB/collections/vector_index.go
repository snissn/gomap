...
// vectorIndexLayer0ConstructionPolicyV1 is an offline-only construction seam.
// It changes the new node's layer-0 selection while leaving reciprocal
// capacity and pruning at the canonical 2M limit.
