...
var mongoGatewayCapabilityManifest = MongoGatewayCapabilityManifest{
	...
	Summaries: []MongoGatewayCapabilitySummary{
		...
		},
		{
			...
			Note: "Bounded standalone subsets only. Explain reports stable primary, secondary, and bounded-scan vocabulary for find, count, distinct, and aggregate pipeline reads; writes, routed reads, and unsupported verbosity reject.",
		},
		{
