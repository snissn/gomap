...
var mongoGatewayCapabilityManifest = MongoGatewayCapabilityManifest{
	...
	Capabilities: []MongoGatewayCapability{
		...
		{ID: "query.negative-existence-and-top-level-nor", Category: "query", Feature: "bounded $ne/$nin/$exists, field $not, and top-level $nor", Status: MongoCapabilitySupportedSubset},
		...
		{ID: "query.bounded-document-only-dotted-projection-and-sort", Category: "query", Feature: "bounded document-only dotted projection and sort", Status: MongoCapabilitySupportedSubset},
