...
`uint32`, `uint64`, `float16`, `bfloat16`), `float32_vector`, `uint32_list`,
`bytes`, and `adjacency_list`.
Current physical typedcolumn types covered: `int64`, `low_cardinality_code`,
`bool`, `float32`, `float64`, #1929 primitive scalar types, `float32_vector`,
...
and the #1929 primitive scalar encodings `raw_int8`, `raw_uint8`, `raw_int16`,
`raw_uint16`, `raw_int32`, `raw_uint32`, `raw_uint64`, `raw_float16`, and
`raw_bfloat16`.
