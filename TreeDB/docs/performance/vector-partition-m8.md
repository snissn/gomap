...
`1254374a4060dd4f681516a8d4088daacdbf7ed5` (the documentation commit is
...
Artifact:
`/mnt/fast4tb/tmp/gomap-3982-1254-matrix-root-p0CDBE/run/matrix/vector_partition_m8_matrix_1254374a4060_0877a375f32e.json`
...
Corpus-exclusive fresh-process peak RSS was `1,908,989,952`, `1,926,139,904`,
and `1,927,917,568` bytes for graph/disjoint, graph/overlap, and stable hash,
...
`/mnt/fast4tb/tmp/gomap-3982-1254-matrix-root-p0CDBE/run/profiles/`.
...
request was `368,679,020` ns against the `30,000,000,000` ns hard limit.
...
GOMAXPROCS=16 GOMEMLIMIT=6GiB \
  ...
  -out /mnt/fast4tb/tmp/gomap-3982-1254-matrix-root-p0CDBE/run/matrix \
  ...
  -profiles /mnt/fast4tb/tmp/gomap-3982-1254-matrix-root-p0CDBE/run/profiles \
