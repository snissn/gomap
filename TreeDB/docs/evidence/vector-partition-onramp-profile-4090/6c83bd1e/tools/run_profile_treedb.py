#!/usr/bin/env python3
"""Run one serialized #4090 TreeDB profiling row."""
...
ROOT = Path("/mnt/fast4tb/gomap-4090-vector-onramp-profile-6c83bd1e")
BINARY = ROOT / "bin/treedb_vector_partition_bench"
REBINDER = ROOT / "bin/rebind_snapshot"
SOURCE_HEAD = "6c83bd1e1f8b0a0aab29bf0fe1cc846fdc944580"
BINARY_SHA = "00b6594b4d14b13169bd4cdc114020d79904facb5c139359602d661a9a7ce99b"
...
CORPORA = {
    "250k": {
        ...
        "descriptor_sha": "f2ce9f0928e6dbb84793462962639c414f790e7cd4a3b34b323c3b123180ef47",
    },
}
GROUPS = ("group-a", "group-b", "group-c", "group-d")
CPUSETS = ("0-2", "3-5", "6-8", "9-11")
CONTROLS = ("single", "native-default", "native-budgeted")
