...
func TestTreeDBStatsDeltaAndPhaseMetrics(t *testing.T) {
	before := map[string]string{
		...
		"treedb.collections.write_domain.indexed_semantic.coalesced_noop_index_changes_total":    "0",
		"treedb.collections.write_domain.indexed_semantic.skipped_secondary_roots_total":         "0",
		"treedb.collections.write_domain.indexed_semantic.duplicate_primary_ids_coalesced_total": "0",
	...
	after := map[string]string{
		...
		"treedb.collections.write_domain.indexed_semantic.coalesced_noop_index_changes_total":    "8",
		"treedb.collections.write_domain.indexed_semantic.skipped_secondary_roots_total":         "12",
		"treedb.collections.write_domain.indexed_semantic.duplicate_primary_ids_coalesced_total": "4",
	...
	for name, want := range map[string]float64{
		...
		"coalesced_noop_index_changes/doc":         0.2,
		"skipped_secondary_roots/doc":              0.3,
		"duplicate_primary_ids_coalesced/doc":      0.1,
...
func TestDeriveTreeDBPhaseMetricsEmitsZeroValues(t *testing.T) {
	...
	for _, name := range []string{
		...
		"coalesced_noop_index_changes/doc",
		"skipped_secondary_roots/doc",
		"duplicate_primary_ids_coalesced/doc",
