...
func TestRenderMarkdownSingle_IncludesTreeDBPerfSections(t *testing.T) {
	...
	for _, want := range []string{
		...
		"publish.ordered_root_delta_group.span_native.triage.delta_batch.status: fallback",
		"publish.ordered_root_delta_group.span_native.triage.delta_batch.fallback_reason: span_native_not_implemented",
...
func TestRenderTreeDBSelectedStatsString_IncludesSpanRunProofCounters(t *testing.T) {
	...
	for _, want := range []string{
		...
		"publish.ordered_root_delta_group.span_native.triage.delta_batch.status: fallback",
		"publish.ordered_root_delta_group.span_native.triage.delta_batch.fallback_reason: span_native_not_implemented",
		"publish.ordered_root_delta_group.span_native.triage.delta_batch.admission_reason: auto_admitted_hardware_aware",
		"publish.ordered_root_delta_group.span_native.triage.command_wal.status: fallback",
		"publish.ordered_root_delta_group.span_native.triage.command_wal.fallback_reason: span_native_not_implemented",
