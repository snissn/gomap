...
func printTreeDBCacheStats(w io.Writer, inst *DBInstance, prefix string) {
	...
	keys := []string{
		...
		"treedb.cache.wal_fence_group.records",
		"treedb.cache.wal_fence_group.keys",
		"treedb.cache.wal_fence_group.chunks",
		"treedb.cache.wal_fence_group.singleton_fallback",
		"treedb.cache.unified_write.set.calls",
		"treedb.cache.unified_write.set.ops",
		"treedb.cache.unified_write.delete.calls",
		"treedb.cache.unified_write.delete.ops",
		"treedb.cache.unified_write.batch.calls",
		"treedb.cache.unified_write.batch.ops",
		"treedb.cache.unified_write.ingress.calls",
		"treedb.cache.unified_write.ingress.ops",
