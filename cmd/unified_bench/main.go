...
func printTreeDBCacheStats(w io.Writer, inst *DBInstance, prefix string) {
	...
	keys := []string{
		...
		"treedb.cache.deferred_vlog.pending_keys_estimate",
		"treedb.cache.deferred_vlog.pending_bytes_estimate",
		"treedb.cache.deferred_vlog.assist_calls",
		...
		"treedb.vlog.leaf_block_cache.policy",
		"treedb.vlog.leaf_block_cache.hits",
		"treedb.vlog.leaf_block_cache.misses",
		"treedb.vlog.leaf_block_cache.hit_ratio",
		"treedb.vlog.leaf_block_cache.entries",
		"treedb.vlog.leaf_block_cache.capacity",
		"treedb.vlog.leaf_block_cache.put_attempts",
		"treedb.vlog.leaf_block_cache.put_admitted",
		"treedb.vlog.leaf_block_cache.put_duplicate_drops",
		"treedb.vlog.leaf_block_cache.put_lock_contention",
