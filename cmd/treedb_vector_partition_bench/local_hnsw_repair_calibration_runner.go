...
func validateLocalHNSWRepairCalibrationReportV1(report localHNSWRepairCalibrationReportV1) error {
	...
	if report.Graph.Rows != 250000 || report.Graph.NativeReachableRows != 299968 || report.Graph.CombinedReachableRows != 250000 || report.Graph.NativeTraversalRoots != 48 || report.Graph.AuxiliaryEdges != 64 || report.Graph.AuxiliaryMaxDegree > 9 {
