...
func TestLocalHNSWAttributionConstructionReducerQualityPostfillOriginV1(t *testing.T) {
	...
	evidence := collections.VectorPartitionConstructionEvidenceV1{
		...
		Partitions: []collections.VectorPartitionConstructionPartitionEvidenceV1{{
			...
			CompactLifecycle:        collections.VectorPartitionConstructionCompactLifecycleV1{QualityPostfillAdd: [8]uint64{0, 0, 0, 0, 0, 1}},
			PostfillEdges:           1,
	...
	totals, err := localHNSWAttributionConstructionReduceV1(evidence)
	if err != nil || totals.QualityPostfillAdded != 1 || totals.VariantRewriteAdded != 0 || totals.FinalQualityPostfill != 1 || totals.QualityPostfillAddByOrigin != [8]uint64{0, 0, 0, 0, 0, 1} {
