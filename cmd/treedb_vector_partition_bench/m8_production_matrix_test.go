...
func TestCommitted4023AttributionLedgerArtifactsV1(t *testing.T) {
	...
	if got.SchemaVersion != 1 || got.Status != "experimental_gate_failures" || got.Disposition != "enablement_off_follow_up_required" || got.MeasuredCodeHead != "69b434d1791f54b7ac08e3fa001decc732b3b953" {
		t.Fatalf("ledger linkage/schema/status=%+v", got)
	}
