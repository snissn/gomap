...
func TestCommitted4023AttributionLedgerArtifactsV1(t *testing.T) {
	...
	if got.SchemaVersion != 1 || got.Status != "experimental_gate_failures" || got.Disposition != "enablement_off_follow_up_required" || got.MeasuredCodeHead != "d801573b9901b73f956a7d713b0d340d54c01b0c" {
		t.Fatalf("ledger linkage/schema/status=%+v", got)
	}
