...
func localHNSWAttributionQueryUtilityAddV1(dst *localHNSWAttributionQueryUtilityV1, value localHNSWAttributionQueryUtilityV1) error {
	...
	for _, pair := range [][2]*localHNSWAttributionQueryOriginUtilityV1{{&dst.Diversity, &value.Diversity}, {&dst.Backfill, &value.Backfill}, {&dst.Reciprocal, &value.Reciprocal}, {&dst.Repair, &value.Repair}, {&dst.Overlay, &value.Overlay}, {&dst.QualityPostfill, &value.QualityPostfill}, {&dst.RobustPrune, &value.RobustPrune}, {&dst.RobustPruneResidual, &value.RobustPruneResidual}, {&dst.Auxiliary, &value.Auxiliary}, {&dst.Unattributed, &value.Unattributed}} {
