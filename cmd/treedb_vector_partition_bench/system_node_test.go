...
func TestVectorPartitionSystemNodeSingleDaemonUsesProductionPublicRouteV1(t *testing.T) {
	...
	if cell.Status != "valid" || cell.Generation.Index == "" || cell.Generation.Generation == 0 || cell.ElapsedNanos == 0 || cell.Metrics.CompletedQueries != len(queries) || cell.Metrics.RecallAt10 <= 0 || cell.Counters["selected_domains"] != uint64(4*len(queries)) || cell.Counters["selected_packs"] != uint64(4*len(queries)) || cell.Counters["selected_partitions"] != uint64(4*len(queries)) || cell.Counters["selected_groups"] == 0 || cell.Counters["query_bytes"] == 0 || cell.Counters["response_bytes"] == 0 || cell.Counters["public_request_frame_bytes"] == 0 || cell.Counters["public_response_frame_bytes"] == 0 || cell.Counters["snapshot_pins"] != uint64(len(queries)) || cell.Counters["read_proofs"] != 0 || cell.Counters["generation_pins"] != 0 || cell.Counters["partition_opens"] != 0 || cell.Timings["total"] == 0 || cell.Timings["coordinator_total"] == 0 || cell.Timings["client_total"] == 0 || cell.Timings["rpc"] == 0 || cell.Timings["read_index_apply"] != 0 || cell.Timings["shard_search"] == 0 || cell.CatalogReads.Total.Total.Reads != uint64(len(queries)) || cell.CatalogReads.Total.StrictSearch.Reads != uint64(len(queries)) || cell.CatalogReads.Total.OperationsHealth.Reads != 0 || cell.CatalogReads.Total.CoordinatorLifecycle.Reads != 0 || cell.CatalogReads.Total.ShardLifecycle.Reads != 0 || cell.CatalogReads.Total.Total.LogBarriers != 0 || cell.CatalogReads.Total.Total.NoLogProofs != cell.CatalogReads.Total.Total.Reads || len(cell.TotalNanos) != len(queries) {
