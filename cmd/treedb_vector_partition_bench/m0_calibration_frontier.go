...
func validateM0FrontierReportV1(report m0FrontierReportV1, probes, efs []int, scoreBudget int) bool {
	...
	if err != nil || m != report.PartitionHNSWM || efConstruction != report.PartitionHNSWEfC || report.OfflineGraphVariant != (variant != collections.VectorPartitionLocalGraphVariantCanonicalVamanaR64L256Alpha1_2V1) {
		return false
	}
